...
function setLoginInputWarning(event, reason) {

    //event必须是JQuery所返回的，而不是原生JavaScript
    try {
        if (!reason) throw new Error("Reason Miss");
        if (event.prop('className') != 'form-login form-login-warning') {

            event.prop('className') == 'form-login form-login-active' ? event.removeClass('form-login-active') : void(0);
            event.addClass('form-login-warning');
...
$(document).ready(function() { //$().load function is deprecated
    ...
    $('#LoginEmailInput').click(function(e) {


        $('#LoginEmailInput').prop('className') != 'form-login form-login-active' || $('#LoginEmailInput').prop('className') != 'form-login form-login-warning form-login-active' ? $('#LoginEmailInput').addClass('form-login-active') : void(0);

        e.stopPropagation();
    });

    $('#LoginPasswordInput').click(function(e) {
        $('LoginPasswordInput').prop('className') != 'form-login form-login-active' || $('#LoginEmailInput').prop('className') != 'form-login form-login-warning form-login-active' ? $('#LoginPasswordInput').addClass('form-login-active') : void(0);
        e.stopPropagation();
    })
    ...
    $('body').click(function() {
        ...
        //Focus
        $('#LoginEmailInput').prop('className') == 'form-login form-login-active' ? $('#LoginEmailInput').removeClass('form-login-active') : void(0);


        $('#LoginPasswordInput').prop('className') == 'form-login form-login-active' ? $('#LoginPasswordInput').removeClass('form-login-active') : void(0);

        //FBI Warning
        $('#LoginEmailInput').prop('className') == 'form-login form-login-warning' ? $('#LoginEmailInput').removeClass('form-login-warning') : void(0);

        $('#LoginPasswordInput').prop('className') == 'form-login form-login-warning' ? $('#LoginPasswordInput').removeClass('form-login-warning') : void(0);
